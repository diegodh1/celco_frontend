import { successSeccion, errorSeccion, successPaths, errorPaths, errorDirectoy, successDirectoy, errorFile, successFile, request } from './actions/actions';
...
const middleware = store => next => action => {
    switch (action.type) {
        ...
        case "REQUEST_PATHS":
            ...
            fetch('http://localhost:4000/getRoutes')
        ...
        case "REQUEST_FILE":
            store.dispatch(request());
            fetch('http://localhost:4000/getb64bits', {
                method: 'POST',
